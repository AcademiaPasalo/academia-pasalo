...
export default function InicioPage() {
  ...
  const courses = [
    {
      ...
      category: 'CIENCIAS',
      cycle: '1° CICLO',
      title: 'Álgebra Matricial y Geometría Analítica',
      teachers: [{ initials: 'AM', name: 'Ana Martínez', avatarColor: '#10b981' }],
    },
    {
      headerColor: '#cd45e8',
      category: 'CIENCIAS',
      ...
      teachers: [
        { initials: 'LG', name: 'Luis García', avatarColor: '#10b981' },
        { initials: 'MR', name: 'María Romero', avatarColor: '#3b82f6' },
      ],
    },
    {
      headerColor: '#68d391',
      ...
      teachers: [{ initials: 'CL', name: 'Carmen López', avatarColor: '#10b981' }],
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 flex flex-row gap-12">
        ...
        <div className="space-y-6">
          ...
          {/* Grid Principal: Cursos (izquierda) | Agenda + CTA (derecha) */}
            ...
            <div className={viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 gap-6' : 'flex flex-col gap-6'}>
              {courses.map((course, index) => (
                <CourseCard
                  ...
                  onViewCourse={() => console.log(`Ver curso: ${course.title}`)}
                  variant={viewMode}
                />
              ))}
            </div>
          ...
          <div className="bg-white rounded-2xl border border-stroke-primary overflow-hidden">
            ...
            <div className="p-3 flex items-center gap-1">
              {[
                ...
                <div
                  key={index}
                  className={`flex-1 px-2 py-1.5 rounded-xl flex flex-col items-center gap-px ${item.active ? 'bg-info-primary-solid/10' : 'bg-white'
                    }`}
                >
