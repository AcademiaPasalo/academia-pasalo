export const ACCESS_MESSAGES = {
  COURSE_CONTENT_FORBIDDEN:
    'No tienes permiso para ver contenido de este curso.',
  ...
  MATERIAL_TEMPLATE_EMPTY_CHILD_NAME:
    'Todos los nombres de subcarpetas deben tener contenido.',
  MATERIAL_TEMPLATE_DUPLICATE_CHILD_NAME:
    'Los nombres de subcarpetas no pueden repetirse.',
} as const;
